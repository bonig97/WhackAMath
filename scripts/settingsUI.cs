...
public partial class settingsUI : Control
{
	...
	{
		PackedScene changePasswordScene = (PackedScene)ResourceLoader.Load("res://scenes/UI/changePasswordUI.tscn");
		GetTree().ChangeSceneToPacked(changePasswordScene);
	}

	private void OnDeleteAccountButtonPressed()
	{
		PackedScene deleteAccountScene = (PackedScene)ResourceLoader.Load("res://scenes/UI/deleteAccountUI.tscn");
		GetTree().ChangeSceneToPacked(deleteAccountScene);
	}

	private void OnBackButtonPressed()
	{
		PackedScene mainUIScene = (PackedScene)ResourceLoader.Load("res://scenes/UI/mainUI.tscn");
